...
const generateVideo = useCallback(async (params) => {
  try {
    ...
    const freepikRes = await fetch("/api/v1/app/freepik/generate-video", {
      method: "POST",
    ...
    // 2️⃣ Step 2: Create backend creation
    ...
    console.log("✅ Backend creation stored with ID:", creationId);

    // 3️⃣ Step 3: Only now subscribe to socket updates
    if (connected) {
      emitEvent("subscribe_creation", {
