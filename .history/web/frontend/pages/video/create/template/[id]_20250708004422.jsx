...
const LoadingStates = {
  ...
  CardLoader: ({ message = "Loading content..." }) => (
    <Card sectioned>
      <BlockStack gap="400" align="center">
        <Spinner accessibilityLabel="Loading content" size="medium" />
            ...
            <BlockStack gap="400">
                ...
                <Text variant="bodyMd" as="p">
                  {isGenerating
                    ...
                    : generatedVideoUrl
                      ...
                      : "Select an image and settings to generate a video"}
                </Text>
              </BlockStack>
              ...
              {isGenerating && (
                <VideoGenerationStatus
                  ...
                  status={generationProgress < 30 ? "Queued" : "IN_PROGRESS"}
                    ...
                    {generatedVideoUrl ? (
                      ...
                      >
                        <LoadingStates.VideoGenerationLoader
                          progress={generationProgress}
                          message={`${generationProgress < 30 ? "Queuing your request..." : "IN_PROGRESS your video..."}`}
                          onCancel={() => {
                            cancelGeneration();
                            showToast("Video generation cancelled");
                          }}
